  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        ...
        {/* My Terrariums button */}
        <TouchableOpacity
          style={styles.myTerrariumsButton}
          onPress={() => router.push('/my-terrariums' as any)}
        >
          <Ionicons name="albums" size={18} color="#1B5E20" style={{ marginRight: 8 }} />
          <Text style={styles.myTerrariumsText}>{t('myTerrariums') || 'Terráriumaim'}</Text>
