...
export const translations = {
  hu: {
    ...
    lightPreference: 'Fényigény (opcionális)',
    lightAny: 'Mindegy',
    lightLow: 'Alacsony',
    lightMedium: 'Közepes',
    lightHigh: 'Magas',
    tempPreference: 'Hőmérséklet (opcionális)',
    tempAny: 'Mindegy',
    tempCool: 'Hűvös (10–20°C)',
    tempRoom: 'Szoba (18–25°C)',
    tempWarm: 'Meleg (22–28°C)',
  ...
  en: {
    ...
    lightPreference: 'Light needs (optional)',
    lightAny: 'Any',
    lightLow: 'Low',
    lightMedium: 'Medium',
    lightHigh: 'High',
    tempPreference: 'Temperature (optional)',
    tempAny: 'Any',
    tempCool: 'Cool (10–20°C)',
    tempRoom: 'Room (18–25°C)',
    tempWarm: 'Warm (22–28°C)',
    saveTerrarium: 'Save',
    exportPDF: 'PDF export',
  ...
  el: {
    ...
    pdfCreated: 'Το PDF δημιουργήθηκε',
    ...
    lightPreference: 'Ανάγκες φωτός (προαιρετικό)',
    lightAny: 'Οποιοδήποτε',
    lightLow: 'Χαμηλό',
    lightMedium: 'Μεσαίο',
    lightHigh: 'Υψηλό',
    tempPreference: 'Θερμοκρασία (προαιρετικό)',
    tempAny: 'Οποιαδήποτε',
    tempCool: 'Δροσερό (10–20°C)',
    tempRoom: 'Δωμάτιο (18–25°C)',
    tempWarm: 'Ζεστό (22–28°C)',
